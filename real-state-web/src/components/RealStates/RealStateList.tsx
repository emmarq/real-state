        ...
        {response.data.Items?.map((realState) => {
          return (
            <li
              ...
              key={realState.Id}
            >
              <div className="absolute z-10 inset-0 bg-gradient-to-b from-transpfrom-transpfrom-transpfrom-transpfrom-transpfrom-transpfrom-transpfrom-transpfrom-transparent to-background "></div>
              <Image
                className="z-0"
                src={realState.Image!}
                fill
